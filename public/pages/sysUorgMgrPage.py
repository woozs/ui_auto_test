...
class SysUorgMgrPage(basepage.Page):
    ...
    def open_uorgmgrpage(self):
        self.dr.open(globalparam.url+"/csdp/manage/#/manage-view/systemManage/sys_uorgMgr")
    ...
    def click_select_mgr(self):
        self.dr.click("xpath->/html/body/app-component/div[1]/main-component/div/div/manage-component/div/div/d"
