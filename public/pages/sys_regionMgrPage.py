...
class SysRegionMgrPage(basepage.Page):
    ...
    def open_sys_regionMgr_page(self):
        self.dr.open(globalparam.url+"/csdp/manage/#/manage-view/systemManage/sys_regionMgr")

    def click_new_resource_node(self):
        self.dr.click("xpath->//button/i")

    def click_region(self):
        self.dr.click("xpath -> //form[@id='regAddAndEdit_form']/div/div/div/div/div/span/span[2]/span ")
    ...
    def click_tree_res_node_i(self,value):
        self.dr.click("xpath->//a[contains(text(),'%s')]/parent::li//child::i"%value)
