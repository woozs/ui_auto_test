...
class SysMorgMgrPage(basepage.Page):
    ...
    def open_sys_morg_mgr_page(self):
        self.dr.open(
            globalparam.url +
            "/csdp/manage/#/manage-view/systemManage/sys_morgMgr")
    ...
    def click_search_user(self):
        self.dr.click(
            "xpath->//div[@id='addUserModal']/div[2]/div/div/form/table-component/div/table/tbody/tr/td[1]/div/span/input[@type='radio']")

    def click_save_user(self):
        self.dr.click(
            "xpath -> //div[@id='addUserModal']/div[@class='modal-footer']/button[@class='btn btn-warning']")
